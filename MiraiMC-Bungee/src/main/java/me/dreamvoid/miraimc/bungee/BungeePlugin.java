...
public class BungeePlugin extends Plugin {
    ...
    public void onEnable() {
        ...
        if(Config.Gen_AddProperties_NoDesktop){
            System.setProperty("no-desktop","MiraiMC");
        }
        if(Config.Gen_AddProperties_SliderCaptchaSupported){
            System.setProperty("slider-captcha-supported","MiraiMC");
        }
