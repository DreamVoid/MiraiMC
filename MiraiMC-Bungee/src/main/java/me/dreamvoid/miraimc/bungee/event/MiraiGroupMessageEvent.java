 ...
 * 被动收到消息 - 群消息
 * @deprecated
 * @see me.dreamvoid.miraimc.bungee.event.message.passive.MiraiGroupMessageEvent
 */
@Deprecated
public final class MiraiGroupMessageEvent extends me.dreamvoid.miraimc.bungee.event.message.passive.MiraiGroupMessageEvent {
