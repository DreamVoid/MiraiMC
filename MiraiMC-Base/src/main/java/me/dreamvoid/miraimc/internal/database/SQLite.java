...
public class SQLite implements Database {
    ...
    public void initialize() throws ClassNotFoundException {
        ...
        */
        ...
        config.setJdbcUrl("jdbc:sqlite:" + new File(MiraiMCConfig.Database.Drivers.SQLite.Path.replace("%plugin_folder%", MiraiMCConfig.PluginDir.toPath().toString())).toPath());
