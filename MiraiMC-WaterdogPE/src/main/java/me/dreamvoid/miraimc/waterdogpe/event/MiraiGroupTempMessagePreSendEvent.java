...
public class MiraiGroupTempMessagePreSendEvent extends Event {
   ...
   /* private static final HandlerList handlers = new HandlerList();
    ...
    public String getSenderNameCard() {
        return event.getTarget().getNameCard();
    }
    ...
    public String getRemark() {
        return event.getTarget().getRemark();
    }
    ...
    public int getBotMuteRemainTime() {
        return event.getGroup().getBotAsMember().getMuteTimeRemaining();
    }
    ...
    public List<Long> getGroupMemberList() {
        ...
        for (NormalMember Member : GroupMemberListOrigin) {
            GroupMemberList.add(Member.getId());
        } // 为返回的数组加入成员
