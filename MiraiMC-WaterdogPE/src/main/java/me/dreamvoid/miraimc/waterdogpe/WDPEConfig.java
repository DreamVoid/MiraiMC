 ...
 * @author zixuan007
 * @description: 配置
 * @date: 2022/3/19 1:50 AM
 */
public class WDPEConfig {
    private final WDPEPlugin plugin;
    private static WDPEConfig Instance;

    public WDPEConfig(WDPEPlugin plugin) {
        Instance = this;
        this.plugin = plugin;
    ...
    public void loadConfig() {
        ...
        Bot_ContactCache_SaveIntervalMillis = plugin.getConfig().getLong("bot.contact-cache.save-interval-millis", 60000L);
