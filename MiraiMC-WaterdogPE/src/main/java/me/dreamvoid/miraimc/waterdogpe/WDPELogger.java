...
public class WDPELogger extends Logger {
     ...
     */
    protected WDPELogger(String name, String resourceBundleName, Plugin plugin) {
    ...
    public void log(Level level, Throwable thrown, Supplier<String> msgSupplier) {
        ...
        if (level != Level.INFO && level != Level.WARNING && level != Level.SEVERE) {
            ...
            logger.warning(msgSupplier.get(), thrown);
        }
    }
    ...
    public void logp(Level level, String sourceClass, String sourceMethod, Supplier<String> msgSupplier) {
        ...
        if (level != Level.INFO && level != Level.WARNING && level != Level.SEVERE) {
            logger.info(msgSupplier.get());
        } else logger.warning(msgSupplier.get());
    }
    ...
    public void logp(Level level, String sourceClass, String sourceMethod, String msg, Throwable thrown) {
        ...
        if (level != Level.INFO && level != Level.WARNING && level != Level.SEVERE) {
            logger.info(msg, thrown);
        } else logger.warning(msg, thrown);
    }
    ...
    public void logp(Level level, String sourceClass, String sourceMethod, Throwable thrown, Supplier<String> msgSupplier) {
        ...
        if (level != Level.INFO && level != Level.WARNING && level != Level.SEVERE) {
            logger.info(msgSupplier.get(), thrown);
        } else logger.warning(msgSupplier.get(), thrown);
    }
