...
public class MiraiImageUploadFailedEvent extends Event {
   ...
   /* private static final HandlerList handlers = new HandlerList();
    ...
    public String getImageID() {
        return event.getSource().calculateResourceId();
    }
    ...
    public byte[] getImageSha1() {
        return event.getSource().getSha1();
    }
    ...
    public String getImageName() {
        return event.getSource().getFormatName();
    }
    ...
    public long getImageSize() {
        return event.getSource().getSize();
    }
