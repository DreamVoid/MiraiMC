...
/**
 * (Velocity) Mirai 核心事件 - 群 - 群成员 - 成员列表变更 - 机器人被邀请加入群
 */
public class MiraiBotInvitedJoinGroupRequestEvent extends AbstractBotEvent {
    ...
    public MiraiBotInvitedJoinGroupRequestEvent(BotInvitedJoinGroupRequestEvent event) {
        ...
        VelocityPlugin.INSTANCE.getServer().getEventManager().fire(new me.dreamvoid.miraimc.velocity.event.MiraiGroupBotInvitedJoinGroupRequestEvent(event));
    }
