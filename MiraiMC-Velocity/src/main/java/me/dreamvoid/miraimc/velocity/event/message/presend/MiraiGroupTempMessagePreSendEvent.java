...
/**
 * (Velocity) Mirai 核心事件 - 消息 - 主动发送消息前 - 群临时会话消息
 */
public class MiraiGroupTempMessagePreSendEvent extends AbstractMessagePreSendEvent {
    public MiraiGroupTempMessagePreSendEvent(GroupTempMessagePreSendEvent event) {
        ...
        VelocityPlugin.INSTANCE.getServer().getEventManager().fire(new me.dreamvoid.miraimc.velocity.event.MiraiGroupTempMessagePreSendEvent(event));
    }
