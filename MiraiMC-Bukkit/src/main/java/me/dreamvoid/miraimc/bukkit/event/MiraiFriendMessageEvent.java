 ...
 * 被动收到消息 - 好友消息
 * @deprecated
 * @see me.dreamvoid.miraimc.bukkit.event.message.passive.MiraiFriendMessageEvent
 */
@Deprecated
public final class MiraiFriendMessageEvent extends me.dreamvoid.miraimc.bukkit.event.message.passive.MiraiFriendMessageEvent {
