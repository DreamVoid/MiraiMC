...
public class MiraiEvent {
    ...
    public void startListenEvent(){
        ...
        // 群
        BotLeaveActiveEventListener = GlobalEventChannel.INSTANCE.subscribeAlways(BotLeaveEvent.Active.class, event -> plugin.getServer().getPluginManager().callEvent(new MiraiGroupBotLeaveEvent(event, event)));
        BotLeaveKickEventListener = GlobalEventChannel.INSTANCE.subscribeAlways(BotLeaveEvent.Kick.class, event -> plugin.getServer().getPluginManager().callEvent(new MiraiGroupBotLeaveEvent(event, event)));
