...
/**
 * (Nukkit) Mirai 核心事件 - 群 - 群成员 - 成员列表变更 - 机器人被邀请加入群
 */
public class MiraiBotInvitedJoinGroupRequestEvent extends AbstractBotEvent {
    ...
    public MiraiBotInvitedJoinGroupRequestEvent(BotInvitedJoinGroupRequestEvent event) {
        ...
        NukkitPlugin.getInstance().getServer().getPluginManager().callEvent(new me.dreamvoid.miraimc.nukkit.event.MiraiGroupBotInvitedJoinGroupRequestEvent(event));
    }
