...
/**
 * (Nukkit) Mirai 核心事件 - 消息 - 主动发送消息前 - 群临时会话消息
 */
public class MiraiGroupTempMessagePreSendEvent extends AbstractMessagePreSendEvent {
    public MiraiGroupTempMessagePreSendEvent(GroupTempMessagePreSendEvent event) {
        ...
        NukkitPlugin.getInstance().getServer().getPluginManager().callEvent(new me.dreamvoid.miraimc.nukkit.event.MiraiGroupTempMessagePreSendEvent(event));
    }
